<template>
  <div class="container mt-3">
    <h1 class="mb-4">HallowFall</h1>

    <div class="card">
      <div class="card-body">
        <h2 class="card-title">專案概述</h2>
        <p class="card-text">HallowFall-backend是一個包含會員功能和社群媒體（發文和留言）功能的網站後端專案。旨在提供一個安全、可擴展和可維護的平台，讓用戶可以進行註冊、登錄、發文和留言等操作。
        </p>
      </div>
    </div>
