<template>
    ...
    <div v-if="!this.userId == 0" class="container mb-3">
        <el-row>
            ...
            <el-col :span="6">註冊日期：<br />{{ targetUser.registrationDate }}</el-col>
            <el-col :span="6">身份類別：<br />{{ targetUser.role }}</el-col>
        </el-row>
        <br />
        <h5>個人簽名</h5>
        <br />
        <froalaView v-model:value="targetUser.signature"></froalaView>
    </div>
